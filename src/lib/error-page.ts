// Página servida quando o próprio SSR falha — ela roda ANTES de qualquer
// JavaScript da aplicação, então é HTML puro, sem dependências.
...
<html lang="pt-BR">
  <head>
    ...
    <style>
      ...
      .primary { background: #0f4c9e; color: #fff; }
